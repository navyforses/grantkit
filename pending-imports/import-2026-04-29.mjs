#!/usr/bin/env node
/**
 * Import 6 new grants discovered on 2026-04-29 (EDUCATION category).
 * Run: DATABASE_URL="..." node pending-imports/import-2026-04-29.mjs
...
const newGrants = JSON.parse(
  readFileSync(new URL("./2026-04-29.json", import.meta.url), "utf-8")
);
...
async function main() {
  ...
  console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`  Daily Discovery Import — 2026-04-29 (EDUCATION)`);
