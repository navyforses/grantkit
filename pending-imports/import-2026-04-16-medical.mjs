/**
 * import-2026-04-16-medical.mjs — Import daily discovery grants (2026-04-16, MEDICAL category)
 * Run with: railway run node pending-imports/import-2026-04-16-medical.mjs
 * Or locally: node pending-imports/import-2026-04-16-medical.mjs (with DATABASE_URL in .env)
 */
...
const grants = require('./2026-04-16-medical.json');
...
console.log(`\nImporting ${grants.length} MEDICAL grants from 2026-04-16 discovery...\n`);
    ...
    await connection.execute(
      `INSERT INTO grants
        (itemId, name, organization, description, category, grantType, country,
         ...
         documentsRequired, targetDiagnosis, ageRange, isActive)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)`,
      [
        grant.itemId,
        grant.name,
