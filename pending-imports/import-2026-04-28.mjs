...
const grantsData = JSON.parse(readFileSync(new URL('./2026-04-28.json', import.meta.url), 'utf-8'));
...
console.log(`\nDone: ${inserted}/${grantsData.length} inserted, ${skipped} duplicates skipped, ${errors} errors`);
