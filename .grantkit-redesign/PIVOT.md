...
| | |
|---|---|
| **მიმდინარე ფაზა** | **Phase 1 — ვალიდაცია + რეპოზიციონირება + პირველი ევრო** (კვირა 2–4). დაწყებული 2026-09-19. Phase 0 კოდის მხრივ დასრულებულია (PR #251, #252); 0.2/0.7/0.10 ოპერატორის ნაბიჯებზეა. |
...
- **2026-09-19 (Phase 1 start)** — მფლობელის გადაწყვეტილება: **1.1 ინტერვიუები/fake-door/cold-call უქმდება** → ჩანაცვლებულია ონლაინ (desk) კვლევით (`integration-pivot/08-online-validation.md`). დანარჩენი Phase 1 სრულდება; Phase 0-ის 0.2/0.7/0.10 ოპერატორის ნაბიჯებზე რჩება. ⛔ გადაწყვეტილებები, რომლებზეც პასუხი არ არის, გეგმის რეკომენდაციით მიდის და ჟურნალში ინიშნება (მფლობელს შეუძლია გადააბრუნოს).
- **2026-09-19 (Phase 1 batch A)** — 1.4 დომენების mapping + org ფილტრები, 1.5 provenance/ნდობის UI, 1.7 მობილური ქმედების ზოლი + react-markdown, 1.8 სერვერული SEO head + `/organizations` + 301-ები, 1.10 audit high 0, ანგარიში 08 (ონლაინ ვალიდაცია: 1.1-ის 5 კრიტერიუმიდან 2 დაფარულია, 1 ნაწილობრივ, 2 — fake-door და WTP — მფლობელის 1 საათს ითხოვს, §5). Ezra-ს რეკომენდაცია D20-ზე: `/health-abroad` FR-მიმართულება სუსტია, ტესტი US/TR-ზე. ახალი ka კონკურენტი/პარტნიორი: kartuli.fr.
- **2026-09-20 (Phase 1 batch B/C)** — 1.2, 1.3, 1.6, 1.9, 1.11, 1.12, 1.13 შესრულებულია. Phase 1-ის კოდის ნაწილი დასრულებულია; დარჩა მხოლოდ მფლობელის/ოპერატორის ნაბიჯები: Resend DNS (1.9), affiliate ანგარიშები (1.13, D19), B2B outreach (1.12), concierge-ის იურიდიული პირი და ფასის დადასტურება (D20, D23), fake-door + WTP (ანგარიში 08 §5). `/health-abroad` noindex-ია და მხოლოდ health კონტექსტიდან იბმება.
