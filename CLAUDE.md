...
- **`client/src/pages/Catalog.tsx`** — კატალოგის გვერდი
  - _მიზეზი:_ დიზაინი და ფუნქციონირება დასრულებულია; ცვლილება არასასურველია
  - თუ ცვლილება აუცილებლად საჭიროა, **ჯერ ჰკითხე მომხმარებელს** ცალსახა ნებართვა
- _(ამ სიაში დაემატება მომავალში თუ სხვა ფაილების გაყინვაც საჭირო გახდება)_

**წესი:** თუ უცნაური ხარ ფაილი გაყინულია თუ არა — იგულისხმე რომ გაყინულია. იკითხე.
