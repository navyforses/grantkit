/**
 * Import script for daily grant discovery — 2026-04-20
 * Category: BUSINESS (Sunday rotation)
 * Run: node pending-imports/import-2026-04-20.mjs
 */
...
const grants = JSON.parse(readFileSync(new URL("./2026-04-20.json", import.meta.url), "utf-8"));
