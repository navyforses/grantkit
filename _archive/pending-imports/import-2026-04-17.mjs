/**
 * Import script for daily grant discovery — 2026-04-17
 * Category: EDUCATION (Friday rotation)
 * Run: node pending-imports/import-2026-04-17.mjs
 */
...
const grants = JSON.parse(readFileSync(new URL("./2026-04-17.json", import.meta.url), "utf-8"));
