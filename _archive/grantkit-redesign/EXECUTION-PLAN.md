...
> # 🗄 ARCHIVED — 2026-04-25
>
> **სტატუსი:** PR#3, PR#4, PR#5 გაუქმდა. PR#1 + PR#2 უკვე main-შია (phantom infrastructure — 0 user-facing ცვლილება).
>
> **მიზეზი:** კვლევის შედეგად დადგინდა რომ სრული Phase 2 user-facing პრობლემას არ წყვეტს, R2 production-outage რისკი აქვს, და France Import (რომელიც ერთადერთი blocked dependency იყო) JSON translation column-ით იხსნება Phase 2-ის გარეშე.
>
> **ერთადერთი დარჩენილი ნაჭერი:** `DROP TABLE organization_translations` (ცარიელი, dead) — France Import-ის pre-step-ად.
>
> დეტალები: `DIAGNOSTIC-2026-04-25.md` § Phase 2.
>
> ფაილი ისტორიული ჩანაწერისთვის რჩება — ქვემოთ წერილი 2026-04-23-ის გადაწყვეტილებებია, დღეს არააქტიური.

---

**შექმნილი:** 2026-04-23
**ავტორიზებული:** შაკო (მომხმარებელი)
**სტატუსი (ისტორიული):** 🟢 მომხმარებელი დაამტკიცა სამივე კრიტიკული რეკომენდაცია. Wave 1 გასაშვებად მზადაა.
